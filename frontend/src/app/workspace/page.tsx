    ...
    try {
      ...
      const res = await apiFetch('/prompts', {
        ...
        body: JSON.stringify({
          ...
          scoreBreakdown: {
            clarity: result.scoreResult.clarity,
            context: result.scoreResult.context,
            specificity: result.scoreResult.specificity,
            constraints: result.scoreResult.constraints,
            outputFormat: result.scoreResult.outputFormat,
            toneAlignment: result.scoreResult.toneAlignment,
          },
          strengths: result.analysis.strengths,
          weaknesses: result.analysis.weaknesses,
          missingContext: result.analysis.missingContext,
